...
if __name__ == '__main__':
    ...
    method_obj = Method_RNN_Classifier('gru text classifier', '', cell_type='gru')
    method_obj.plot_filename = 'gru_classification_convergence.png'
    ...
    print('************ Start Stage 4 GRU Classification ************')
    setting_obj.prepare(data_obj, method_obj, result_obj, evaluate_obj)
    setting_obj.print_setup_summary()

    scores, _ = setting_obj.load_run_save_evaluate()

    print('************ Overall Performance (GRU classification test) ************')
