...
if __name__ == '__main__':
    ...
    method_obj = Method_RNN_Generator('lstm text generator', '', cell_type='lstm')
    method_obj.plot_filename = 'lstm_generation_convergence.png'
    ...
    print('************ Start Stage 4 LSTM Generation ************')
    setting_obj.prepare(data_obj, method_obj, result_obj, evaluate_obj)
    setting_obj.print_setup_summary()

    scores, _ = setting_obj.load_run_save_evaluate()

    print('************ Overall Performance (LSTM generation validation) ************')
